...
def test_pr159_atomicrows_completion_requires_accepted_packet():
    assert all(record["accepted_source_packet_ref_or_null"] is None for record in atomicrows_records())
