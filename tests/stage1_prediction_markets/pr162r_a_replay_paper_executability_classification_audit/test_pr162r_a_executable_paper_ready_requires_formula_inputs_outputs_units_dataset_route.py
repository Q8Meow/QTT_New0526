...
def test_pr162r_a_executable_paper_ready_requires_formula_inputs_outputs_units_dataset_route(records):
    ...
    for row in executable:
        ...
        assert dataset[row["candidate_id"]]["paper_data_binding_flag"]
