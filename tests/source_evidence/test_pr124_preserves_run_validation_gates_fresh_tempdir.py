...
def test_pr124_preserves_fresh_unique_pytest_basetemp_command_shape():
    validation_dir = Path(".tmp") / "pr124_validation_temp_contract"
    pytest_basetemp = validation_dir / "run_validation_gates_pytest_PR124_UNIQUE"
