...
def normalize_repo_relative_ref(repo_root: Path, ref: Any, *, label: str = "PR163 path") -> str:
    raw_path = str(ref)
...
def normalize_shard_ref(repo_root: Path, shard_ref: Any) -> str:
    return normalize_repo_relative_ref(repo_root, shard_ref, label="PR163 shard path")
