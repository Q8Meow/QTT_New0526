"""Deterministic PR162 report sharding."""
...
SUMMARY_COUNT_FIELDS = (
    ...
    "candidate_backend_family",
    "comparator_blueprint_status",
    "dataset_authority_class",
    "dataset_status",
    "live_hot_path_admissibility",
    "pr161e_handoff_state",
    "qku_coverage_state",
    "quantum_forward_promotion_state",
    "quantum_readiness_state",
    "result_readiness_state",
    "source_class",
    "validation_status",
)
...
def payloads_for_write(
    ...
    for filename in c.REPORT_FILENAMES:
        ...
        payload["full_records_canonical_location"] = "PR162_FULL_RECORD_SHARDS"
        main_payloads[filename] = payload
        manifest_records.append(
            {
                "record_id": f"PR162-SHARD-MANIFEST-{Path(filename).stem}",
                ...
                "canonical_records_location": "PR162_FULL_RECORD_SHARDS",
            }
        )
