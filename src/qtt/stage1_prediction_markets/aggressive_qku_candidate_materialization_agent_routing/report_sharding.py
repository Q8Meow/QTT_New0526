"""Deterministic report sharding for PR162D."""
...
SUMMARY_COUNT_FIELDS = (
    ...
    "authority_class",
    "confidence_class",
    "pr162d_progress_status",
    "field_fill_status",
    "route_status",
    "candidate_kind",
    "problem_model_type",
    "quantum_execution_mode",
    "backend_adapter_family",
)
...
def payloads_for_write(
    ...
    for filename in c.REPORT_FILENAMES:
        ...
        payload["full_records_canonical_location"] = "PR162D_FULL_RECORD_SHARDS"
        main_payloads[filename] = payload
        manifest_records.append(
            {
                "record_id": f"PR162D-SHARD-MANIFEST-{Path(filename).stem}",
                ...
                "canonical_records_location": "PR162D_FULL_RECORD_SHARDS",
