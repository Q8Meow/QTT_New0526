"""Authority boundary helpers for PR166-SM2."""
...
def authority_boundary_record() -> dict[str, Any]:
    payload = {
        ...
        "score_memory_refresh_only": True,
        "replay_paper_only": True,
        "positive_replay_paper_edge_is_profit_evidence": False,
        "conversion_candidate_is_positive_result": False,
