"""Central authority defaults for PR166-QC."""
...
def authority_boundary_record() -> dict[str, object]:
    return {
        "authority_scope": "PR166_QC_NONLIVE_REPLAY_PAPER_EVIDENCE_ONLY",
        "replay_paper_evidence_live_ready_allowed_in_this_pr": False,
        ...
        "candidate_values_route": "NONLIVE_REPLAY_PAPER_OR_DOWNSTREAM_REVIEW_ONLY",
    }
