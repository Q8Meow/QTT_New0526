...
class ReasonCode(StrEnum):
    ...
    CONTRACT_OR_TYPE_INVALID = "ST12D_CONTRACT_OR_TYPE_INVALID"
    IDENTITY_OR_VERSION_UNRESOLVED = "ST12D_IDENTITY_OR_VERSION_UNRESOLVED"
    INPUT_OWNER_OR_SOURCE_INVALID = "ST12D_INPUT_OWNER_OR_SOURCE_INVALID"
    POINT_IN_TIME_FRESHNESS_OR_SEQUENCE_INVALID = (
        "ST12D_POINT_IN_TIME_FRESHNESS_OR_SEQUENCE_INVALID"
    )
    UNIT_BASIS_OR_PRECISION_INVALID = "ST12D_UNIT_BASIS_OR_PRECISION_INVALID"
    PARAMETER_POLICY_OR_PIN_INVALID = "ST12D_PARAMETER_POLICY_OR_PIN_INVALID"
    DEPENDENCY_OR_COMPUTABILITY_INCOMPLETE = (
        "ST12D_DEPENDENCY_OR_COMPUTABILITY_INCOMPLETE"
    )
    EVIDENCE_REFERENCE_UNAVAILABLE_STALE_CONFLICTING_OR_SCOPE_MISMATCH = (
        "ST12D_EVIDENCE_REFERENCE_UNAVAILABLE_STALE_CONFLICTING_OR_SCOPE_MISMATCH"
    )
    KILL_SUBMIT_DISABLED_OR_SAFETY_BLOCK = (
        "ST12D_KILL_SUBMIT_DISABLED_OR_SAFETY_BLOCK"
    )
    OWNER_CONFIRMATION_OR_SEGREGATION_OF_DUTIES_REQUIRED = (
        "ST12D_OWNER_CONFIRMATION_OR_SEGREGATION_OF_DUTIES_REQUIRED"
    )
    NO_TRADE_OR_EXISTING_OWNER_REOPTIMIZATION_ROUTE = (
        "ST12D_NO_TRADE_OR_EXISTING_OWNER_REOPTIMIZATION_ROUTE"
    )
    LATER_TRANCHE_AUTHORITY_REQUIRED = "ST12D_LATER_TRANCHE_AUTHORITY_REQUIRED"
    CENTRAL_ADMISSION_PASS = "ST12D_CENTRAL_ADMISSION_PASS"
    EVIDENCE_UNAVAILABLE_F_NOT_IMPLEMENTED = (
        "ST12D_EVIDENCE_UNAVAILABLE_F_NOT_IMPLEMENTED"
    )
    POLICY_OR_SNAPSHOT_STALE = "ST12D_POLICY_OR_SNAPSHOT_STALE"
    KILL_OR_SUBMIT_DISABLED = "ST12D_KILL_OR_SUBMIT_DISABLED"
    OWNER_CONFIRMATION_REQUIRED = "ST12D_OWNER_CONFIRMATION_REQUIRED"
    ALLOW_ELIGIBLE_NOT_ACTIVATED = "ST12D_ALLOW_ELIGIBLE_NOT_ACTIVATED"
    SNAPSHOT_CANDIDATE_BUILT = "ST12D_SNAPSHOT_CANDIDATE_BUILT"
    SNAPSHOT_CANDIDATE_VALID = "ST12D_SNAPSHOT_CANDIDATE_VALID"
    SNAPSHOT_CANDIDATE_INVALID = "ST12D_SNAPSHOT_CANDIDATE_INVALID"
    SNAPSHOT_STALE = "ST12D_SNAPSHOT_STALE"
    ROLLBACK_REQUIRED = "ST12D_ROLLBACK_REQUIRED"
    ROLLBACK_PROPOSAL_VALID = "ST12D_ROLLBACK_PROPOSAL_VALID"
    NO_VALID_ROLLBACK_TARGET = "ST12D_NO_VALID_ROLLBACK_TARGET"
    RETIREMENT_DRAIN = "ST12D_RETIREMENT_DRAIN"
    RETIRED = "ST12D_RETIRED"
    NO_TRADE_REOPTIMIZATION_ROUTED = "ST12D_NO_TRADE_REOPTIMIZATION_ROUTED"
    SNAPSHOT_PIN_CONFLICT = "ST12D_SNAPSHOT_PIN_CONFLICT"
    SEQUENCE_GAP = "ST12D_SEQUENCE_GAP"
    MATCHING_PRIORITY_UNKNOWN = "ST12D_MATCHING_PRIORITY_UNKNOWN"
    LATENCY_PROFILE_REQUIRED = "ST12D_LATENCY_PROFILE_REQUIRED"
    RESOURCE_BOUND_EXCEEDED = "ST12D_RESOURCE_BOUND_EXCEEDED"
    CLOCK_DOMAIN_MISMATCH = "ST12D_CLOCK_DOMAIN_MISMATCH"
    ST12F_TEMPLATE_ROSTER_MISMATCH = "ST12F_TEMPLATE_ROSTER_MISMATCH"
    ST12F_INPUT_LOCK_MISMATCH = "ST12F_INPUT_LOCK_MISMATCH"
    ST12F_LANE_SUBSTITUTION_FORBIDDEN = "ST12F_LANE_SUBSTITUTION_FORBIDDEN"
    ST12F_RESULT_SLOT_CONFLICT = "ST12F_RESULT_SLOT_CONFLICT"
    ST12F_EVIDENCE_INCOMPLETE = "ST12F_EVIDENCE_INCOMPLETE"
    ST12F_INDEPENDENT_REVIEW_REQUIRED = "ST12F_INDEPENDENT_REVIEW_REQUIRED"
    ST12F_SELF_REVIEW_FORBIDDEN = "ST12F_SELF_REVIEW_FORBIDDEN"
    ST12F_MODEL_RISK_VETO = "ST12F_MODEL_RISK_VETO"
    ST12F_QUANTUM_TRACE_INVALID = "ST12F_QUANTUM_TRACE_INVALID"
    ST12F_LLM_ANNOTATION_INVALID = "ST12F_LLM_ANNOTATION_INVALID"
    ST12F_FIXTURE_NOT_EVIDENCE = "ST12F_FIXTURE_NOT_EVIDENCE"
    ST12F_BUNDLE_STALE = "ST12F_BUNDLE_STALE"
    ST12F_EVIDENCE_IDENTITY_INVALID = "ST12F_EVIDENCE_IDENTITY_INVALID"
