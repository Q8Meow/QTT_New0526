...
class ReasonCode(StrEnum):
    ...
    SOURCE_BINDING_REQUIRED = "ST12B_SOURCE_BINDING_REQUIRED"
    SOURCE_CLAIM_BINDING_MISMATCH = "ST12B_SOURCE_CLAIM_BINDING_MISMATCH"
    INPUT_ORIGIN_NOT_AUTHORIZED = "ST12B_INPUT_ORIGIN_NOT_AUTHORIZED"
    DERIVED_LINEAGE_INVALID = "ST12B_DERIVED_LINEAGE_INVALID"
    ...
    EXECUTION_REQUIREMENTS_UNRESOLVED = (
        "ST12B_EXECUTION_REQUIREMENTS_UNRESOLVED"
    )
    PARAMETER_ASSERTION_MISMATCH = "ST12B_PARAMETER_ASSERTION_MISMATCH"
    PARAMETER_RUNTIME_BINDING_REQUIRED = (
        "ST12B_PARAMETER_RUNTIME_BINDING_REQUIRED"
    )
    PARAMETER_APPLICATION_UNBOUND = "ST12B_PARAMETER_APPLICATION_UNBOUND"
    PARAMETER_EXPLICIT_FAIL_CLOSED = "ST12B_PARAMETER_EXPLICIT_FAIL_CLOSED"
