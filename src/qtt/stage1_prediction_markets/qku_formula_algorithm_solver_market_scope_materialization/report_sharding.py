"""Deterministic PR162B report sharding."""
...
def payloads_for_write(
    ...
    for filename in c.REPORT_FILENAMES:
        ...
        payload["full_records_canonical_location"] = "PR162B_FULL_RECORD_SHARDS"
        main_payloads[filename] = payload
        manifest_records.append(
            {
                "record_id": f"PR162B-SHARD-MANIFEST-{Path(filename).stem}",
                ...
                "canonical_records_location": "PR162B_FULL_RECORD_SHARDS",
