"""PR165 non-live authority boundary policy."""
...
PR_ID = "PR165"
EXPECTED_BRANCH = "pr165-evidence-backed-scoring-ranking"
AUTHORITY_CLASS = "PR165_EVIDENCE_BACKED_SCORING_RANKING_REPLAY_PAPER_ONLY"
POLICY_MODULE_REF = (
    "src.qtt.stage1_prediction_markets."
    "pr165_evidence_backed_scoring_ranking.scoring_authority_policy"
)
...
def authority_boundary_record(subject_id: str) -> dict[str, Any]:
    return {
        "authority_boundary_ref": f"PR165_AUTHORITY_BOUNDARY::{subject_id}",
...
def no_authority_record(record_ref: str) -> dict[str, Any]:
    return {
...
def validate_record_authority(record: dict[str, Any]) -> AuthorityValidation:
    ...
    boundary = record.get("authority_boundary_record")
