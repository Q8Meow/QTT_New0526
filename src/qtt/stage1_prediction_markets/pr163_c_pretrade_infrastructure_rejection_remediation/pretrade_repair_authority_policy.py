"""Authority policy for PR163-C replay/paper-only repair artifacts."""
...
AUTHORITY_CLASS = "PR163_C_PRETRADE_INFRA_REPAIR_REPLAY_PAPER_ONLY"
POLICY_MODULE_REF = (
    "src.qtt.stage1_prediction_markets."
    "pr163_c_pretrade_infrastructure_rejection_remediation."
    "pretrade_repair_authority_policy"
)
...
BOUNDARY_COUNT_FIELDS: dict[str, int] = {
    ...
    "pr163_c_created_ref_integrity_authority_violation_count": 0,
}
...
FILES_INTENTIONALLY_NOT_TOUCHED = (
    ...
    "protected AtomicRows checksum artifacts",
    "source acceptance truth packets",
    "connector semantic binding truth packets",
    "private-state, runtime-cash, order, and live artifacts",
)
...
def no_authority_record(record_id: str, audit_family: str) -> dict[str, Any]:
    return {
        ...
        "authority_decision": "NO_AUTHORITY_CREATED_BY_PR163_C",
        "validation_status": "PASS",
        "live_order_authority": False,
        "source_acceptance": False,
        "connector_binding": False,
        "private_state_fetch": False,
