"""Authority boundary helpers for PR166-SM3."""
...
def authority_boundary_record() -> dict[str, object]:
    return {
        "authority_scope": "PR166_SM3_SCORE_MEMORY_REFRESH_V3_REPLAY_PAPER_ONLY",
        "replay_paper_positive_label_allowed": (
            "REFRESHED_REPLAY_PAPER_POSITIVE_EVIDENCE_NOT_PROFIT"
        ),
        "owner_review_label_allowed": "OWNER_REVIEW_REQUESTED_NOT_LIVE_APPROVED",
