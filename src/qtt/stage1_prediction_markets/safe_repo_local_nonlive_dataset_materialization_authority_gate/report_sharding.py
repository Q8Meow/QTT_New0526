"""Deterministic PR162A report sharding."""
...
SUMMARY_COUNT_FIELDS = (
    ...
    "run_capable_gate_status",
    "rerun_readiness_state",
    "source_class",
)
...
def payloads_for_write(
    ...
    for filename in c.REPORT_FILENAMES:
        ...
        payload["full_records_canonical_location"] = "PR162A_FULL_RECORD_SHARDS"
        main_payloads[filename] = payload
        manifest_records.append(
            {
                "record_id": f"PR162A-SHARD-MANIFEST-{Path(filename).stem}",
                ...
                "canonical_records_location": "PR162A_FULL_RECORD_SHARDS",
            }
        )
