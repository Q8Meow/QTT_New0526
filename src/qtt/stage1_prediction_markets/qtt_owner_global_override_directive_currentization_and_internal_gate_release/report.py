...
from tools.ci_branch_context import BranchContext, current_branch_context, is_pr_or_later_branch
...
def _is_allowed_pr143_changed_path_for_branch(path: str, branch: str) -> bool:
    return path.replace("\\", "/") in c.ALLOWED_PR143_CHANGED_PATHS and (
        _branch_allows_pr143_changed_paths(branch)
    )
