...
def main() -> int:
    ...
    for field in (
        ...
        "negative_memory_rows_semantics",
        "hard_negative_memory_rows",
        "condition_scoped_avoid_rows",
        "neutral_insufficient_evidence_rows",
        "sparse_regime_watch_rows",
        "retest_required_rows",
        "qku_untradable_rows",
        "permanent_rejection_rows",
        "live_ban_rows",
