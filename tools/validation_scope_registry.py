...
PR168_RECOVERY1_BRANCH = "pr168-recovery1-rank3-guided-repair-retest"
...
_PR168_RECOVERY1_ALLOWED_EXACT_PATHS = frozenset(
    {
...
_PR168_RECOVERY1_ALLOWED_PATTERNS = (
    "docs/master_plan/generated/PR168_RECOVERY1_*.report.json",
    "docs/master_plan/generated/recovery1/*.jsonl",
    "docs/master_plan/generated/recovery1/*.manifest.json",
    "docs/master_plan/generated/recovery1/**/*.jsonl",
    "docs/master_plan/generated/recovery1/**/*.manifest.json",
...
def _pr168_recovery1_scope_decision(branch_name: str, normalized: str) -> dict[str, object] | None:
    if normalized in _PR168_RECOVERY1_ALLOWED_EXACT_PATHS:
        return {
            "allowed": True,
            "branch": branch_name,
            "normalized_path": normalized,
            "pr_id": "PR168-RECOVERY1",
            "matched_rule": f"exact:{normalized}",
            "reason": "registered_exact_path",
        }
    for pattern in _PR168_RECOVERY1_ALLOWED_PATTERNS:
        if fnmatchcase(normalized, pattern):
            return {
                "allowed": True,
                "branch": branch_name,
...
def explain_pr_scope_decision(branch: str, path: str) -> dict[str, object]:
    ...
    if branch_name == PR168_RECOVERY1_BRANCH:
        recovery1_decision = _pr168_recovery1_scope_decision(branch_name, normalized)
        if recovery1_decision:
            return recovery1_decision
        return {
            "allowed": False,
            "branch": branch_name,
            "normalized_path": normalized,
            "pr_id": "PR168-RECOVERY1",
            "matched_rule": "no_pr168_recovery1_scope_rule",
            "reason": "path_not_registered_for_pr_scope",
        }
