#!/usr/bin/env python3
"""Report and shard IO for PR168-RP2-MAP2."""
...
def write_shard(key: str, rows: Iterable[Mapping[str, Any]], *, logical_family_id: str) -> dict[str, Any]:
    ...
    manifest = {
        ...
        **route_defaults("agent", row_shard_refs=[generated_ref(path)], upstream_refs=[logical_family_id]),
    }
...
def report_payload(
    ...
    *,
    ...
    return {
        "report_id": report_id,
        "physical_filename": f"docs/master_plan/generated/{physical}",
        "logical_to_physical_alias_ref": "docs/master_plan/generated/PR168_RP2_FileAliases.report.json",
        "path_length_audit_ref": "docs/master_plan/generated/PR168_RP2_PathAudit.report.json",
