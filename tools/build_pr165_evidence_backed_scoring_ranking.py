...
from src.qtt.stage1_prediction_markets.pr165_evidence_backed_scoring_ranking import paths as p  # noqa: E402
from src.qtt.stage1_prediction_markets.pr165_evidence_backed_scoring_ranking.json_io import read_json  # noqa: E402
from src.qtt.stage1_prediction_markets.pr165_evidence_backed_scoring_ranking.report_builder import write_artifacts  # noqa: E402
...
def main() -> int:
    ...
    if args.verify_idempotent:
        ...
        if before != after:
            print("PR165_EVIDENCE_BACKED_SCORING_RANKING_IDEMPOTENCE_FAILED", file=sys.stderr)
            return 1
        print("PR165_EVIDENCE_BACKED_SCORING_RANKING_IDEMPOTENT")
    summary = artifacts.summary
    print("PR165_EVIDENCE_BACKED_SCORING_RANKING_BUILT")
    for field in (
        "scored_candidate_rows",
        "global_ranking_rows",
        "regime_sliced_ranking_rows",
        "score_component_rows",
        "remaining_materialization_plan_rows",
        "repair_routing_rows",
