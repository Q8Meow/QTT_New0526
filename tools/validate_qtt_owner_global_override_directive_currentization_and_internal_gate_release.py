...
from src.qtt.stage1_prediction_markets.qtt_owner_global_override_directive_currentization_and_internal_gate_release import (  # noqa: E402
    constants as c,
)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--write-artifacts",
        action="store_true",
        help="Regenerate the deterministic PR143 schema, YAML, report, and fixture.",
    )
