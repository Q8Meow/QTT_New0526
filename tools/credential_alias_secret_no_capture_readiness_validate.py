...
SUCCESS_MARKER = "QTT_CREDENTIAL_ALIAS_SECRET_NO_CAPTURE_READINESS_GATE_OK"
FAILURE_MARKER = "QTT_CREDENTIAL_ALIAS_SECRET_NO_CAPTURE_READINESS_GATE_FAILED"
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        if args.check_only:
            artifacts = build_credential_readiness_artifacts(args.repo_root)
        else:
